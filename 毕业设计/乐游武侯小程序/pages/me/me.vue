			...
			<view class="user-info">
				...
				<view class="user-content">
					<view class="user-imgbox">
						<view class="user-img"><u-avatar :src="userInfo.avatarUrl"></u-avatar></view>
					</view>
				...
				<view class="user-tabs">
					...
					<view class="tab-item" @tap="gotoLink('/subpages/history/history')">
						<image class="tab-svg" src="@/static/bell.png" mode="aspectFit" />
						<text class="tab-name">浏览历史</text>
							...
							<view class="feed-info">
								...
								<view class="iview">
									<view class="ilike" @tap.stop="checkLove(item)">
										<image v-if="getUser_check().includes(item.id)" src="@/static/ysc.png" class="micon" />
