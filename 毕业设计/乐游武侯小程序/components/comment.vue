	...
	<view>
		...
		<view class="comments">
			...
			<view v-for="(commentItem, index) in oneInfo" :key="index" class="one-comment">
				...
				<view class="commenter">
					<view class="info">
						<view class="left">
							<u-avatar size="25" class="avatar" src="http://127.0.0.1:8080/public/head/head_sculpture_boy.png" />
		...
		<view class="tab-bar">
			...
			<view class="mview">
				...
				<view class="mbtn" @tap="checkLove">
					<image class="micon" :src="usercheck && usercheck.includes(postid) ? '/static/ysc.png' : '/static/sc.png' "
					 mode="aspectFit" />
				...
				<view class="mbtn" @tap="toComment">
					<image class="micon" src="/static/xx.png" mode="aspectFit" />
				...
				<view class="mbtn">
					<button class="mbtns" open-type="share">
						<image class="micon" src="/static/fx.png" mode="aspectFit" />
		...
		<view class="commentBox" v-if="showCommentBox">
			<view class="header">
				...
				<u-icon class="icon" name="arrow-down-fill" color="#999" size="28" @tap="openComment" />
			</view>
